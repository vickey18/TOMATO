...
const Header = () => {
  ...
  const {setNightMode,nightMode} = useContext(StoreContext) 
  ...
  const handleChange=  ()=>{
    ...
    var element = document.querySelector("body");
      element.style.backgroundColor = nightMode ? 'white' : 'black';
      element.style.color = nightMode ? 'black' : 'white';
   }


  return (
    <div className={nightMode?"header nightactive":"header"}>
      <div className="night-button">
            <FormControlLabel 
